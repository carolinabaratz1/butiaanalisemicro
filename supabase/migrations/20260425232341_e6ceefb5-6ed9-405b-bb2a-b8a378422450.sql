-- Função para recalcular apenas métricas DI/PRE/OUTRO
...
-- Função para recalcular apenas métricas IPCA
...
-- Reescreve a função original para apenas chamar as duas em sequência
