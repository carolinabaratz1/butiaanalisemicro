...
ALTER TABLE public."allocation_limits" DROP CONSTRAINT IF EXISTS "allocation_limits_fundo_categoria_subcategoria_key";
...
ALTER TABLE public."allocation_targets" DROP CONSTRAINT IF EXISTS "allocation_targets_period_fundo_tipo_key";
...
ALTER TABLE public."allocation_targets_emissor" DROP CONSTRAINT IF EXISTS "allocation_targets_emissor_period_id_fundo_cnpj_emissor_key";
...
ALTER TABLE public."allocation_targets_setor" DROP CONSTRAINT IF EXISTS "allocation_targets_setor_period_id_fundo_setor_key";
...
ALTER TABLE public."credit_opinions" DROP CONSTRAINT IF EXISTS "credit_opinions_fidc_month_uniq";
ALTER TABLE public."credit_opinions" ADD CONSTRAINT "credit_opinions_fidc_month_uniq" UNIQUE (fidc_id, reference_month);
ALTER TABLE public."cvm_data_dictionary" DROP CONSTRAINT IF EXISTS "cvm_data_dictionary_table_name_column_name_key";
...
ALTER TABLE public."cvm_fidc_field_mapping" DROP CONSTRAINT IF EXISTS "cvm_fidc_field_mapping_metric_name_key";
ALTER TABLE public."cvm_fidc_field_mapping" ADD CONSTRAINT "cvm_fidc_field_mapping_metric_name_key" UNIQUE (metric_name);
ALTER TABLE public."cvm_monthly_import_staging" DROP CONSTRAINT IF EXISTS "cvm_monthly_import_staging_reference_month_cnpj_key";
...
ALTER TABLE public."emissoes" DROP CONSTRAINT IF EXISTS "emissoes_isin_key";
...
ALTER TABLE public."fidc_quota_classes" DROP CONSTRAINT IF EXISTS "fidc_quota_classes_isin_key";
ALTER TABLE public."fidc_quota_classes" ADD CONSTRAINT "fidc_quota_classes_isin_key" UNIQUE (isin);
ALTER TABLE public."fidcs" DROP CONSTRAINT IF EXISTS "fidcs_cnpj_key";
ALTER TABLE public."fidcs" ADD CONSTRAINT "fidcs_cnpj_key" UNIQUE (cnpj);
ALTER TABLE public."issuer_ratings" DROP CONSTRAINT IF EXISTS "issuer_ratings_unique";
...
ALTER TABLE public."trade_ntnb" DROP CONSTRAINT IF EXISTS "trade_ntnb_bond_name_data_key";
ALTER TABLE public."trade_ntnb" ADD CONSTRAINT "trade_ntnb_bond_name_data_key" UNIQUE (bond_name, data);
ALTER TABLE public."trade_taxas" DROP CONSTRAINT IF EXISTS "trade_taxas_ticker_data_key";
...
ALTER TABLE public."alert_rules" DROP CONSTRAINT IF EXISTS "alert_rules_created_by_fkey";
...
ALTER TABLE public."alert_rules" DROP CONSTRAINT IF EXISTS "alert_rules_fidc_id_fkey";
...
ALTER TABLE public."alerts" DROP CONSTRAINT IF EXISTS "alerts_fidc_id_fkey";
ALTER TABLE public."alerts" ADD CONSTRAINT "alerts_fidc_id_fkey" FOREIGN KEY (fidc_id) REFERENCES fidcs(id) ON DELETE CASCADE;
ALTER TABLE public."allocation_targets" DROP CONSTRAINT IF EXISTS "allocation_targets_period_id_fkey";
...
ALTER TABLE public."allocation_targets_emissor" DROP CONSTRAINT IF EXISTS "allocation_targets_emissor_period_id_fkey";
...
ALTER TABLE public."allocation_targets_setor" DROP CONSTRAINT IF EXISTS "allocation_targets_setor_period_id_fkey";
...
ALTER TABLE public."assembleia_participacoes" DROP CONSTRAINT IF EXISTS "assembleia_participacoes_assembleia_id_fkey";
...
ALTER TABLE public."assembleias" DROP CONSTRAINT IF EXISTS "assembleias_cnpj_empresa_fkey";
...
ALTER TABLE public."assembleias" DROP CONSTRAINT IF EXISTS "assembleias_isin_fkey";
...
ALTER TABLE public."credit_opinions" DROP CONSTRAINT IF EXISTS "credit_opinions_author_id_fkey";
...
ALTER TABLE public."credit_opinions" DROP CONSTRAINT IF EXISTS "credit_opinions_fidc_id_fkey";
...
ALTER TABLE public."cvm_monthly_import_staging" DROP CONSTRAINT IF EXISTS "cvm_monthly_import_staging_fidc_id_fkey";
...
ALTER TABLE public."empresas" DROP CONSTRAINT IF EXISTS "empresas_setor_fkey";
...
ALTER TABLE public."fidc_alert_events" DROP CONSTRAINT IF EXISTS "fidc_alert_events_rule_id_fkey";
...
ALTER TABLE public."fidc_alert_rules" DROP CONSTRAINT IF EXISTS "fidc_alert_rules_criado_por_fkey";
...
ALTER TABLE public."fidc_monthly_quota_classes" DROP CONSTRAINT IF EXISTS "fidc_monthly_quota_classes_fidc_monthly_report_id_fkey";
...
ALTER TABLE public."fidc_monthly_quota_classes" DROP CONSTRAINT IF EXISTS "fidc_monthly_quota_classes_fidc_quota_class_id_fkey";
...
ALTER TABLE public."fidc_monthly_reports" DROP CONSTRAINT IF EXISTS "fidc_monthly_reports_fidc_id_fkey";
...
ALTER TABLE public."fidc_monthly_reports" DROP CONSTRAINT IF EXISTS "fidc_monthly_reports_imported_by_fkey";
...
ALTER TABLE public."fidc_monthly_segments" DROP CONSTRAINT IF EXISTS "fidc_monthly_segments_fidc_id_fkey";
...
ALTER TABLE public."fidc_quota_classes" DROP CONSTRAINT IF EXISTS "fidc_quota_classes_fidc_id_fkey";
...
ALTER TABLE public."fidc_rating_history" DROP CONSTRAINT IF EXISTS "fidc_rating_history_fidc_id_fkey";
...
ALTER TABLE public."fidc_rating_history" DROP CONSTRAINT IF EXISTS "fidc_rating_history_fidc_quota_class_id_fkey";
...
ALTER TABLE public."fidc_subordination_limits" DROP CONSTRAINT IF EXISTS "fidc_subordination_limits_fidc_id_fkey";
...
ALTER TABLE public."pipeline_eventos" DROP CONSTRAINT IF EXISTS "pipeline_eventos_user_id_fkey";
...
ALTER TABLE public."trade_upload_log" DROP CONSTRAINT IF EXISTS "trade_upload_log_uploaded_by_fkey";
...
ALTER TABLE public."analises" DROP CONSTRAINT IF EXISTS "analises_conviccao_check";
...
ALTER TABLE public."analises" DROP CONSTRAINT IF EXISTS "analises_decisao_check";
...
ALTER TABLE public."assembleia_participacoes" DROP CONSTRAINT IF EXISTS "assembleia_participacoes_voto_check";
...
ALTER TABLE public."assembleias" DROP CONSTRAINT IF EXISTS "assembleias_modalidade_check";
...
ALTER TABLE public."assembleias" DROP CONSTRAINT IF EXISTS "assembleias_status_check";
...
ALTER TABLE public."assembleias" DROP CONSTRAINT IF EXISTS "assembleias_voto_butia_check";
...
ALTER TABLE public."emissoes" DROP CONSTRAINT IF EXISTS "emissoes_fidc_classe_chk";
...
ALTER TABLE public."emissoes" DROP CONSTRAINT IF EXISTS "emissoes_fidc_tipo_chk";
...
ALTER TABLE public."fidc_classes" DROP CONSTRAINT IF EXISTS "fidc_classes_classe_chk";
...
ALTER TABLE public."trade_ativos" DROP CONSTRAINT IF EXISTS "trade_ativos_indexador_check";
...
ALTER TABLE public."trade_upload_log" DROP CONSTRAINT IF EXISTS "trade_upload_log_status_check";
