...
export const rolePermissions: Record<UserRole, RolePermissions> = {
  'Gestor': {
    sections: ['/', '/posicoes', '/empresas', '/analises', '/pipeline', '/pipeline-de-research', '/credito/corporativo', '/credito/estruturado', '/acoes', '/analistas', '/configuracoes', '/assembleias'],
    canWrite: true,
    canManageUsers: true,
  ...
  'Coordenação/Especialista': {
    sections: ['/', '/posicoes', '/empresas', '/analises', '/pipeline-de-research', '/credito/corporativo', '/credito/estruturado', '/acoes', '/analistas', '/assembleias'],
    canWrite: true,
  ...
  'Analista': {
    sections: ['/', '/posicoes', '/empresas', '/analises', '/pipeline-de-research', '/credito/corporativo', '/credito/estruturado', '/acoes', '/assembleias'],
    canWrite: true,
    canManageUsers: false,
  ...
  'Consulta': {
    sections: ['/', '/posicoes', '/empresas', '/analises', '/pipeline-de-research', '/credito/corporativo', '/credito/estruturado', '/assembleias'],
    canWrite: false,
    canManageUsers: false,
    canViewAllDashboards: false,
    canApproveAnalyses: false,
