export type UserRole = 'Gestor' | 'Analista' | 'Risco e Compliance' | 'Consulta';
...
export const users: User[] = [
  { id: 'u1', nome: 'Luana Varotto Marques', email: 'luanamarques@butiainvestimentos.com.br', funcao: 'Risco e Compliance', status: 'Ativo' },
  ...
  { id: 'u4', nome: 'Vandeir Ribeiro Gontijo Filho', email: 'vandeirgontijo@butiainvestimentos.com.br', funcao: 'Gestor', status: 'Ativo' },
  ...
  { id: 'u8', nome: 'Ennio Ferreira de Moraes Júnior', email: 'enniomoraes@butiainvestimentos.com.br', funcao: 'Analista', status: 'Ativo' },
  { id: 'u9', nome: 'Paulo Marcelo Furlan de Melo', email: 'paulofurlan@butiainvestimentos.com.br', funcao: 'Analista', status: 'Ativo' },
  { id: 'u10', nome: 'Victor Alves do Espírito Santo', email: 'victoralves@butiainvestimentos.com.br', funcao: 'Risco e Compliance', status: 'Ativo' },
  ...
  { id: 'u13', nome: 'Laura Nogueira', email: 'lauranogueira@butiainvestimentos.com.br', funcao: 'Consulta', status: 'Ativo' },
  { id: 'u14', nome: 'Ighor Fonseca', email: 'ighorfonseca@butiainvestimentos.com.br', funcao: 'Consulta', status: 'Ativo' },
  { id: 'u15', nome: 'Felipe Vianna', email: 'felipevianna@butiainvestimentos.com.br', funcao: 'Consulta', status: 'Ativo' },
];
